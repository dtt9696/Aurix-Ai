...
## 2. Human Capital & Visa Trends (H1B)
- **Source**: H1B Salary Data API, DOL LCA Disclosures.
- **Key Data**: H1B sponsorship volume, visa denial rates, prevailing wage gaps.
- **Risk Indicator**: Sudden drop in H1B filings (potential downsizing), reliance on specialized foreign talent (operational fragility).

## 3. Social & Recruitment (LinkedIn)
- **Source**: Apify LinkedIn Scraper, RapidAPI LinkedIn.
- **Key Data**: Executive turnover, recruitment velocity, employee sentiment.
- **Risk Indicator**: Mass exodus of key engineering talent, hiring freeze in core departments.

## 4. Physical Intelligence (Google Maps)
- **Source**: ADK `google_maps_grounding` tool.
